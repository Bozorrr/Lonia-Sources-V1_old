package net.lonia.moderation.gui.staff.moderator.moderation;
...
public class ModerationGui implements GuiBuilder {

    public static final ItemStack Sanction_SanctionPanel_Ico = new ItemBuilder(Material.BOOK).setName("§cPanel de sanction").setLore("§65 catégories").toItemStack();
