...
public class MuteCMD extends AbstractCommand {
    ...
    protected boolean onCommand(CommandSender sender, String label, String[] args) {
        ...
        if (args.length >= 3) {
            ...
            if (uuid != null) {
                ...
                long durationInSeconds = parseDurationInSeconds(timeArg);

                if (durationInSeconds <= 0) {
                    player.sendMessage("§9[Sanction] §3Erreur: La durée est incorrecte.");
                    return true;
                }
                ...
                SanctionManager.mute(uuid, targetName, durationInSeconds, date, player.getName(), reason);
                return true;
            } else player.sendMessage("§9[Sanction] §3Erreur: Ce pseudonyme n'existe pas.");

        } else player.sendMessage("§9[Sanction] §3Utilisation: /mute (Pseudo) (Durée) (Motif)");
