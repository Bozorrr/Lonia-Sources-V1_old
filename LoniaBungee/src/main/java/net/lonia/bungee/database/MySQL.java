...
public class MySQL {
    ...
    public void createTablesData_Servers() {
        createTableID("data_servers", "id SMALLINT, name VARCHAR(255), bungee_name VARCHAR(255), type VARCHAR(255), status VARCHAR(255), connected_player SMALLINT, enabled_chat BIT");
    }

    public void createTablesData_Players() {
        createTableID("data_players", "name VARCHAR(255), uuid VARCHAR(255), grade VARCHAR(255), power INT, etoile BIGINT, argent BIGINT, server TEXT, connected BIT, isInGame BIT");
    }

    public void createTablesData_Settings() {
        createTableID("data_settings", "uuid VARCHAR(255), enabled_mp BIT, enabled_friends_request BIT, enabled_group_request BIT, enabled_following_group BIT, enabled_show_particle_effects BIT, enabled_show_all_sanctions BIT");
    }
    ...
    public void createTablesGroups() {
        createTableID("data_groups", "leader_uuid VARCHAR(255), leader_name VARCHAR(255), max_members TINYINT");
    }
    ...
    public void createTablesReports() {
        createTableID("reports", "uuid VARCHAR(255), pseudo VARCHAR(255), ");
    }
