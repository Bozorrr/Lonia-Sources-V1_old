...
public class ConfirmationPaymentLegend implements GuiBuilder {

    final ItemStack ConfirmationLegend = new ItemBuilder(Material.EMERALD).setName("§bLégende").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, ConfirmationLegend);
