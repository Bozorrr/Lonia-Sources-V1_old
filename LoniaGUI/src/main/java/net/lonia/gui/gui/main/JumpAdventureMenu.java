...
public class JumpAdventureMenu implements GuiBuilder {

    private final ItemStack JUMPADVENTURE_ICO = new ItemBuilder(Material.LADDER).setName("§2Jump/Aventure").toItemStack();

    @Override
    public String name() {
        return "§2§lJump/Aventure";
    }
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, JUMPADVENTURE_ICO);
        inv.setItem(11, ServerItemManager.JUMPADVENTURE1);
        inv.setItem(13, ServerItemManager.JUMPADVENTURE2);
        inv.setItem(15, ServerItemManager.JUMPADVENTURE3);
