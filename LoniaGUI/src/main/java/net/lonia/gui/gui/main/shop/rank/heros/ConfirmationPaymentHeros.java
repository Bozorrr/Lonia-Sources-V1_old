...
public class ConfirmationPaymentHeros implements GuiBuilder {

    final ItemStack ConfirmationHeros = new ItemBuilder(Material.DIAMOND).setName("§bHéros").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, ConfirmationHeros);
