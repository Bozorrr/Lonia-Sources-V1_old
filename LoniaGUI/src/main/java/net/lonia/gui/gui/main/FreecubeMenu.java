...
public class FreecubeMenu implements GuiBuilder {

    private final ItemStack FREECUBE_ICO = new ItemBuilder(Material.GRASS).setName("§bFreecube").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, FREECUBE_ICO);
        inv.setItem(13, ServerItemManager.FREECUBE);
