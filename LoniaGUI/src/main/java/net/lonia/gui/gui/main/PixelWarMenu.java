...
public class PixelWarMenu implements GuiBuilder {

    private final ItemStack PIXELWAR_ICO = new ItemBuilder(Material.WOOL).setName("§bPixel War").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, PIXELWAR_ICO);
        inv.setItem(13, ServerItemManager.PIXELWAR);
