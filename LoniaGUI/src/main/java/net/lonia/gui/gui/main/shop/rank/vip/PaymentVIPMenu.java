package net.lonia.gui.gui.main.shop.rank.vip;
...
public class PaymentVIPMenu implements GuiBuilder {

    final ItemStack Payment_VIP_Ico = new ItemBuilder(Material.INK_SACK, 1, 4).setName("§bVIP").toItemStack();
