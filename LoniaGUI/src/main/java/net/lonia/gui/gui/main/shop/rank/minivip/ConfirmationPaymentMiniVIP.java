...
public class ConfirmationPaymentMiniVIP implements GuiBuilder {

    final ItemStack ConfirmationMiniVIP = new ItemBuilder(Material.REDSTONE).setName("§bMini-VIP").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, ConfirmationMiniVIP);
