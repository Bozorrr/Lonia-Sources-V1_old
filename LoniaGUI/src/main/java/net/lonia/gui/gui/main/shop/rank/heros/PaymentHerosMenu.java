package net.lonia.gui.gui.main.shop.rank.heros;
...
public class PaymentHerosMenu implements GuiBuilder {

    final ItemStack Payment_HEROS_Ico = new ItemBuilder(Material.DIAMOND).setName("§bHéros").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, Payment_HEROS_Ico);
