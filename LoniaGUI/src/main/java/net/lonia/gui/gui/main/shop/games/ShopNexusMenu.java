...
public class ShopNexusMenu implements GuiBuilder {
    ItemStack MONEY;
    final ItemStack LVL1 = new ItemBuilder(Material.QUARTZ).setName("§eNiveau 1").setLore("").toItemStack();
    @Override
    public String name() {
        return "§eBoutique du Nexus";
    }
