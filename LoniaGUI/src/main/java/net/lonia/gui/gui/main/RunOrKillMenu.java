...
public class RunOrKillMenu implements GuiBuilder {

    private final ItemStack RUNORKILL_ICO = new ItemBuilder(Material.SNOW_BALL).setName("§bRUN or KILL").toItemStack();

    @Override
    public String name() {
        return "§7§lRUN or KILL";
    }
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, RUNORKILL_ICO);

        inv.setItem(11, ServerItemManager.RUNORKILL1);
