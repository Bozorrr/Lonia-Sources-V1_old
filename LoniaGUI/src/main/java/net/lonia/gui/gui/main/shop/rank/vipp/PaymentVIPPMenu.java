...
public class PaymentVIPPMenu implements GuiBuilder {

    final ItemStack Payment_VIPP_Ico = new ItemBuilder(Material.GOLD_INGOT).setName("§bVIP+").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, Payment_VIPP_Ico);
