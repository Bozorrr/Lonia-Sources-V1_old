...
public class ConfirmationPaymentVIP implements GuiBuilder {

    final ItemStack ConfirmationVIP = new ItemBuilder(Material.INK_SACK, 1, 4).setName("§bVIP").toItemStack();
