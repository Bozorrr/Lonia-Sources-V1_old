package net.lonia.gui.gui.main.shop.rank.legend;
...
public class PaymentLegendMenu implements GuiBuilder {

    final ItemStack Payment_Legend_Ico = new ItemBuilder(Material.EMERALD).setName("§bLégende").toItemStack();
    ...
    public void contents(Player player, Inventory inv) {
        inv.setItem(0, Payment_Legend_Ico);
